...
function AppRouter() {
  ...
  return (
    <Routes>
      <Route index element={<MainMenuView mainMenuViewModel={mainMenuViewModel}/>}/>
      <Route path="editor/:currentDbId" element={<EditorView editorViewModel={useEditorViewModel(dbModel)}/>}>
